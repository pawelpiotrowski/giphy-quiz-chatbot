...
module.exports = class Outbound {
    ...
    async reply(template, payload, attachment) {
        Log.info(['OUTBOUND -> Reply',[template, payload, attachment]]);
        await Messenger[this.getReplyCommandString(template)](this.recipientId, payload, attachment);
    }
